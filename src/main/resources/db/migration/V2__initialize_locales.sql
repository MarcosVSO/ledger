INSERT INTO ledger.ledger.ufs (id,sigla,nome)
VALUES
    (11, 'RO', 'Rondônia'),
    (12, 'AC', 'Acre'),
    (13, 'AM', 'Amazonas'),
...
INSERT INTO ledger.ledger.municipios (id,nome,uf)
VALUES
    ...
    (5000203, 'Água Clara', 25),
    (5000252, 'Alcinópolis', 25),
    (5000609, 'Amambai', 25),
    (5000708, 'Anastácio', 25),
    (5000807, 'Anaurilândia', 25),
    (5000856, 'Angélica', 25),
    (5000906, 'Antônio João', 25),
    (5001003, 'Aparecida do Taboado', 25),
    (5001102, 'Aquidauana', 25),
    (5001243, 'Aral Moreira', 25),
    (5001508, 'Bandeirantes', 25),
    (5001904, 'Bataguassu', 25),
    (5002001, 'Batayporã', 25),
    (5002100, 'Bela Vista', 25),
    (5002159, 'Bodoquena', 25),
    (5002209, 'Bonito', 25),
    (5002308, 'Brasilândia', 25),
    (5002407, 'Caarapó', 25),
    (5002605, 'Camapuã', 25),
    (5002704, 'Campo Grande', 25),
    (5002803, 'Caracol', 25),
    (5002902, 'Cassilândia', 25),
    (5002951, 'Chapadão do Sul', 25),
    (5003108, 'Corguinho', 25),
    (5003157, 'Coronel Sapucaia', 25),
    (5003207, 'Corumbá', 25),
    (5003256, 'Costa Rica', 25),
    (5003306, 'Coxim', 25),
    (5003454, 'Deodápolis', 25),
    (5003488, 'Dois Irmãos do Buriti', 25),
    (5003504, 'Douradina', 25),
    (5003702, 'Dourados', 25),
    (5003751, 'Eldorado', 25),
    (5003801, 'Fátima do Sul', 25),
    (5003900, 'Figueirão', 25),
    (5004007, 'Glória de Dourados', 25),
    (5004106, 'Guia Lopes da Laguna', 25),
    (5004304, 'Iguatemi', 25),
    (5004403, 'Inocência', 25),
    (5004502, 'Itaporã', 25),
    (5004601, 'Itaquiraí', 25),
    (5004700, 'Ivinhema', 25),
    (5004809, 'Japorã', 25),
    (5004908, 'Jaraguari', 25),
    (5005004, 'Jardim', 25),
    (5005103, 'Jateí', 25),
    (5005152, 'Juti', 25),
    (5005202, 'Ladário', 25),
    (5005251, 'Laguna Carapã', 25),
    (5005400, 'Maracaju', 25),
    (5005608, 'Miranda', 25),
    (5005681, 'Mundo Novo', 25),
    (5005707, 'Naviraí', 25),
    (5005806, 'Nioaque', 25),
    (5006002, 'Nova Alvorada do Sul', 25),
    (5006200, 'Nova Andradina', 25),
    (5006259, 'Novo Horizonte do Sul', 25),
    (5006275, 'Paraíso das Águas', 25),
    (5006309, 'Paranaíba', 25),
    (5006358, 'Paranhos', 25),
    (5006408, 'Pedro Gomes', 25),
    (5006606, 'Ponta Porã', 25),
    (5006903, 'Porto Murtinho', 25),
    (5007109, 'Ribas do Rio Pardo', 25),
    (5007208, 'Rio Brilhante', 25),
    (5007307, 'Rio Negro', 25),
    (5007406, 'Rio Verde de Mato Grosso', 25),
    (5007505, 'Rochedo', 25),
    (5007554, 'Santa Rita do Pardo', 25),
    (5007695, 'São Gabriel do Oeste', 25),
    (5007703, 'Sete Quedas', 25),
    (5007802, 'Selvíria', 25),
    (5007901, 'Sidrolândia', 25),
    (5007935, 'Sonora', 25),
    (5007950, 'Tacuru', 25),
    (5007976, 'Taquarussu', 25),
    (5008008, 'Terenos', 25),
    (5008305, 'Três Lagoas', 25),
    (5008404, 'Vicentina', 25),
    (5100102, 'Acorizal', 51),
    (5100201, 'Água Boa', 51),
